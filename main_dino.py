...
def get_args_parser():
    ...
    parser.add_argument('--patch_size', default=2, type=int, help="""Size in pixels
...
def train_dino(args):
    ...
    val_transform = pth_transforms.Compose([
        ...
        pth_transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010)),
    ])
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, data_loader,
    ...
    for it, (images, target) in enumerate(metric_logger.log_every(data_loader, 10, header)):
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):
            ...
            classifier_loss = nn.CrossEntropyLoss()(classifier_output , target)
            loss = arsg.lambda * classifier_loss + (1-args.lambda) * dino_loss(student_output, teacher_output, epoch)
